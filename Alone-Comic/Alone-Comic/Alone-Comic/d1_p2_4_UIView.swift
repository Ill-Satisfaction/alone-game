...
//  Alone-Comic
//
//  Created by Adam Azevedo on 4/24/20.
//  Copyright © 2020 250_DreamTeam. All rights reserved.
//

import UIKit

class d1_p2_4_UIView: UINavigationController {
    
    // set all subpanels IN ORDER
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        return [
            UIStoryboard(name: "Main", bundle: nil) .instantiateViewController(withIdentifier: "d1_p2_4_a"),
